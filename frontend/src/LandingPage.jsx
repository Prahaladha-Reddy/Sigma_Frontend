...
export default function LandingPage({ supabaseClient }) {
  ...
  return (
    <div className="min-h-screen bg-black font-sans text-white overflow-x-hidden">
      ...
      ========================================= */}
      <section className="relative w-full h-screen border-y border-white/5 bg-zinc-950/50">
        ...
        <div className="relative w-full h-full max-w-[1920px] mx-auto overflow-hidden">
            ...
            {/* A. LEFT SIDEBAR */}
            <aside className="absolute left-4 top-4 bottom-4 w-64 bg-zinc-900/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl z-30 flex flex-col overflow-hidden">
            ...
            {/* B. MAIN SLIDE AREA */}
            <main className="absolute inset-0 ml-[280px] flex flex-col items-center justify-center p-4 z-10 transition-all duration-500">
              
              <div className="relative w-full h-full flex items-center justify-center group">
                <img 
                  src={activeDeck.slides[currentSlide]} 
                  alt="Presentation Slide"
                  className="max-w-full max-h-full w-auto h-auto object-contain shadow-[0_0_60px_rgba(0,0,0,0.6)] rounded-md transition-transform duration-500"
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-3 px-4 py-2 bg-zinc-950/80 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0 z-20">
